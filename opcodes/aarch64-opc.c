...
const aarch64_sys_reg aarch64_sys_regs [] =
{
  ...
  { "icc_iar1_el1",	 CPENC(3,0,C12,C12,0), 0 },
  { "icc_iar0_el1",	 CPENC(3,0,C12,C8,0),  0 },
  { "icc_eoir1_el1",	 CPENC(3,0,C12,C12,1), 0 },
  { "icc_eoir0_el1",	 CPENC(3,0,C12,C8,1),  0 },
  { "icc_hppir1_el1",	 CPENC(3,0,C12,C12,2), 0 },
  { "icc_hppir0_el1",	 CPENC(3,0,C12,C8,2),  0 },
  { "icc_bpr1_el1",	 CPENC(3,0,C12,C12,3), 0 },
  { "icc_bpr0_el1",	 CPENC(3,0,C12,C8,3),  0 },
  { "icc_dir_el1",	 CPENC(3,0,C12,C11,1), 0 },
  { "icc_pmr_el1",	 CPENC(3,0,C4,C6,0),   0 },
  { "icc_rpr_el1",	 CPENC(3,0,C12,C11,3), 0 },
  { "icc_ctlr_el1",	 CPENC(3,0,C12,C12,4), 0 },
  { "icc_ctlr_el3",	 CPENC(3,6,C12,C12,4), 0 },
  { "icc_sre_el1",	 CPENC(3,0,C12,C12,5), 0 },
  { "icc_sre_el2",	 CPENC(3,4,C12,C9,5),  0 },
  { "icc_sre_el3",	 CPENC(3,6,C12,C12,5), 0 },
  { "icc_igrpen0_el1",	 CPENC(3,0,C12,C12,6), 0 },
  { "icc_igrpen1_el1",	 CPENC(3,0,C12,C12,7), 0 },
  { "icc_igrpen1_el3",	 CPENC(3,6,C12,C12,7), 0 },
  { "icc_seien_el1",	 CPENC(3,0,C12,C13,0), 0 },
  { "icc_sgi1r_el1",	 CPENC(3,0,C12,C11,5), 0 },
  { "icc_asgi1r_el1",	 CPENC(3,0,C12,C11,6), 0 },
  { "icc_sgi0r_el1",	 CPENC(3,0,C12,C11,7), 0 },
  { "icc_ap0r0_el1",	 CPENC(3,0,C12,C8,4),  0 },
  { "icc_ap0r1_el1",	 CPENC(3,0,C12,C8,5),  0 },
  { "icc_ap0r2_el1",	 CPENC(3,0,C12,C8,6),  0 },
  { "icc_ap0r3_el1",	 CPENC(3,0,C12,C8,7),  0 },
  { "icc_ap1r0_el1",	 CPENC(3,0,C12,C9,0),  0 },
  { "icc_ap1r1_el1",	 CPENC(3,0,C12,C9,1),  0 },
  { "icc_ap1r2_el1",	 CPENC(3,0,C12,C9,2),  0 },
  { "icc_ap1r3_el1",	 CPENC(3,0,C12,C9,3),  0 },
  { "ich_ap0r0_el2",	 CPENC(3,4,C12,C8,0),  0 },
  { "ich_ap0r1_el2",	 CPENC(3,4,C12,C8,1),  0 },
  { "ich_ap0r2_el2",	 CPENC(3,4,C12,C8,2),  0 },
  { "ich_ap0r3_el2",	 CPENC(3,4,C12,C8,3),  0 },
  { "ich_ap1r0_el2",	 CPENC(3,4,C12,C9,0),  0 },
  { "ich_ap1r1_el2",	 CPENC(3,4,C12,C9,1),  0 },
  { "ich_ap1r2_el2",	 CPENC(3,4,C12,C9,2),  0 },
  { "ich_ap1r3_el2",	 CPENC(3,4,C12,C9,3),  0 },
  { "ich_hcr_el2",	 CPENC(3,4,C12,C11,0), 0 },
  { "ich_vtr_el2",	 CPENC(3,4,C12,C11,1), 0 },
  { "ich_misr_el2",	 CPENC(3,4,C12,C11,2), 0 },
  { "ich_eisr_el2",	 CPENC(3,4,C12,C11,3), 0 },
  { "ich_elsr_el2",	 CPENC(3,4,C12,C11,5), 0 },
  { "ich_vmcr_el2",	 CPENC(3,4,C12,C11,7), 0 },
  { "ich_vseir_el2",	 CPENC(3,4,C12,C9,4),  0 },
  { "ich_lr0_el2",	 CPENC(3,4,C12,C12,0), 0 },
  { "ich_lr1_el2",	 CPENC(3,4,C12,C12,1), 0 },
  { "ich_lr2_el2",	 CPENC(3,4,C12,C12,2), 0 },
  { "ich_lr3_el2",	 CPENC(3,4,C12,C12,3), 0 },
  { "ich_lr4_el2",	 CPENC(3,4,C12,C12,4), 0 },
  { "ich_lr5_el2",	 CPENC(3,4,C12,C12,5), 0 },
  { "ich_lr6_el2",	 CPENC(3,4,C12,C12,6), 0 },
  { "ich_lr7_el2",	 CPENC(3,4,C12,C12,7), 0 },
  { "ich_lr8_el2",	 CPENC(3,4,C12,C13,0), 0 },
  { "ich_lr9_el2",	 CPENC(3,4,C12,C13,1), 0 },
  { "ich_lr10_el2",	 CPENC(3,4,C12,C13,2), 0 },
  { "ich_lr11_el2",	 CPENC(3,4,C12,C13,3), 0 },
  { "ich_lr12_el2",	 CPENC(3,4,C12,C13,4), 0 },
  { "ich_lr13_el2",	 CPENC(3,4,C12,C13,5), 0 },
  { "ich_lr14_el2",	 CPENC(3,4,C12,C13,6), 0 },
  { "ich_lr15_el2",	 CPENC(3,4,C12,C13,7), 0 },
  { 0,          CPENC(0,0,0,0,0), 0  },
};
