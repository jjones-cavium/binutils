...
const struct aarch64_operand aarch64_operands[] =
{
  ...
  {AARCH64_OPND_CLASS_INT_REG, "Rz", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_Rz}, "XZR register"},
  ...
  {AARCH64_OPND_CLASS_SYSTEM, "CACHEREG", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {}, "a cache register"},
  {AARCH64_OPND_CLASS_SYSTEM, "CACHEZERO", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {}, "a cache register"},
