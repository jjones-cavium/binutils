...
/* Notes on implementation:
  ...
  adrp x0, :tlsgd:foo
                           R_AARCH64_P32_TLSGD_ADR_PAGE21(foo)
  add  x0, :tlsgd_lo12:foo
                           R_AARCH64_P32_TLSGD_ADD_LO12_NC(foo)
  bl   __tls_get_addr
  nop
  ...
  adrp  x0, :tlsdesc:foo                      R_AARCH64_P32_TLSDESC_ADR_PAGE21(foo)
  ldr   x1, [x0, #:tlsdesc_lo12:foo]          R_AARCH64_P32_TLSDESC_LD32_LO12(foo)
  add   x0, x0, #:tlsdesc_lo12:foo            R_AARCH64_P32_TLSDESC_ADD_LO12(foo)
  .tlsdesccall foo
  blr   x1                                    R_AARCH64_P32_TLSDESC_CALL(foo)

  The relocations R_AARCH64_P32_TLSGD_{ADR_PREL21,ADD_LO12_NC} against foo
  indicate that foo is thread local and should be accessed via the
  traditional TLS mechanims.

  The relocations R_AARCH64_P32_TLSDESC_{ADR_PAGE,LD32_LO12_NC,ADD_LO12_NC}
  ...
  entries. The static linker places the relocation R_AARCH64_P32_TLS_DTPMOD
  ...
  R_AARCH64_P32_TLS_DTPREL relocation on the offset entry. The loader
  ...
  R_AARCH64_P32_TLSDESC on the first GOT slot. The loader will
  ...
  The TLS relocations R_AARCH64_P32_TLSGD_{ADR_PREL21,ADD_LO12_NC} and
  R_AARCH64_P32_TLSDESC_{ADR_PAGE,LD32_LO12_NC,ADD_LO12_NC} are
  ...
  Fixup the R_AARCH64_P32_TLSGD_{ADR_PREL21, ADD_LO12_NC} relocations.
...
#define IS_AARCH64_TLS_RELOC(R_TYPE)			\
  ((R_TYPE) == R_AARCH64_P32_TLSGD_ADR_PAGE21		\
   || (R_TYPE) == R_AARCH64_P32_TLSGD_ADD_LO12_NC		\
   || (R_TYPE) == R_AARCH64_P32_TLSIE_ADR_GOTTPREL_PAGE21	\
   || (R_TYPE) == R_AARCH64_P32_TLSIE_LD32_GOTTPREL_LO12_NC	\
   || (R_TYPE) == R_AARCH64_P32_TLSIE_LD_GOTTPREL_PREL19	\
   || (R_TYPE) == R_AARCH64_P32_TLSLE_ADD_TPREL_LO12	\
   || (R_TYPE) == R_AARCH64_P32_TLSLE_ADD_TPREL_HI12	\
   || (R_TYPE) == R_AARCH64_P32_TLSLE_ADD_TPREL_LO12_NC	\
   || (R_TYPE) == R_AARCH64_P32_TLSLE_MOVW_TPREL_G1		\
   || (R_TYPE) == R_AARCH64_P32_TLSLE_MOVW_TPREL_G0		\
   || (R_TYPE) == R_AARCH64_P32_TLSLE_MOVW_TPREL_G0_NC	\
   || (R_TYPE) == R_AARCH64_P32_TLS_DTPMOD		\
   || (R_TYPE) == R_AARCH64_P32_TLS_DTPREL		\
   || (R_TYPE) == R_AARCH64_P32_TLS_TPREL			\
   || IS_AARCH64_TLSDESC_RELOC ((R_TYPE)))

#define IS_AARCH64_TLSDESC_RELOC(R_TYPE)		\
  ((R_TYPE) == R_AARCH64_P32_TLSDESC_LD_PREL19		\
   || (R_TYPE) == R_AARCH64_P32_TLSDESC_ADR_PREL21		\
   || (R_TYPE) == R_AARCH64_P32_TLSDESC_ADR_PAGE21		\
   || (R_TYPE) == R_AARCH64_P32_TLSDESC_ADD_LO12		\
   || (R_TYPE) == R_AARCH64_P32_TLSDESC_LD32_LO12	\
   || (R_TYPE) == R_AARCH64_P32_TLSDESC_CALL		\
   || (R_TYPE) == R_AARCH64_P32_TLSDESC)

#define ELIMINATE_COPY_RELOCS 0

/* Return the relocation section associated with NAME.  HTAB is the
   bfd's elf32_aarch64_link_hash_entry.  */
#define RELOC_SECTION(HTAB, NAME) \
  ((HTAB)->use_rel ? ".rel" NAME : ".rela" NAME)

/* Return size of a relocation entry.  HTAB is the bfd's
   elf32_aarch64_link_hash_entry.  */
#define RELOC_SIZE(HTAB) (sizeof (Elf64_External_Rela))

/* Return function to swap relocations in.  HTAB is the bfd's
   elf32_aarch64_link_hash_entry.  */
#define SWAP_RELOC_IN(HTAB) (bfd_elf32_swap_reloca_in)

/* Return function to swap relocations out.  HTAB is the bfd's
   elf32_aarch64_link_hash_entry.  */
#define SWAP_RELOC_OUT(HTAB) (bfd_elf32_swap_reloca_out)
...
static reloc_howto_type elf32_aarch64_howto_none =
  HOWTO (R_AARCH64_P32_NONE,	/* type */
	 ...
	 "R_AARCH64_P32_NONE",	/* name */
	 FALSE,			/* partial_inplace */
	 0,			/* src_mask */
	 0,			/* dst_mask */
	 FALSE);		/* pcrel_offset */

static reloc_howto_type elf32_aarch64_howto_dynrelocs[] = {

  HOWTO (R_AARCH64_P32_COPY,	/* type */
	 0,			/* rightshift */
	 ...
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_COPY",	/* name */
	 TRUE,			/* partial_inplace */
	 0xffffffff,		/* src_mask */
	 0xffffffff,		/* dst_mask */
	 FALSE),		/* pcrel_offset */

  HOWTO (R_AARCH64_P32_GLOB_DAT,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 64,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_bitfield,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_GLOB_DAT",	/* name */
	 TRUE,			/* partial_inplace */
	 0xffffffff,		/* src_mask */
	 0xffffffff,		/* dst_mask */
	 FALSE),		/* pcrel_offset */

  HOWTO (R_AARCH64_P32_JUMP_SLOT,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 64,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_bitfield,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_JUMP_SLOT",	/* name */
	 TRUE,			/* partial_inplace */
	 0xffffffff,		/* src_mask */
	 0xffffffff,		/* dst_mask */
	 FALSE),		/* pcrel_offset */

  HOWTO (R_AARCH64_P32_RELATIVE,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 64,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_bitfield,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_RELATIVE",	/* name */
	 TRUE,			/* partial_inplace */
	 ALL_ONES,		/* src_mask */
	 ALL_ONES,		/* dst_mask */
	 FALSE),		/* pcrel_offset */

  HOWTO (R_AARCH64_P32_TLS_DTPMOD,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 64,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLS_DTPMOD",	/* name */
	 FALSE,			/* partial_inplace */
	 0,			/* src_mask */
	 ALL_ONES,		/* dst_mask */
	 FALSE),		/* pc_reloffset */

  HOWTO (R_AARCH64_P32_TLS_DTPREL,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 64,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLS_DTPREL",	/* name */
	 FALSE,			/* partial_inplace */
	 0,			/* src_mask */
	 ALL_ONES,		/* dst_mask */
	 FALSE),		/* pcrel_offset */

  HOWTO (R_AARCH64_P32_TLS_TPREL,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 64,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLS_TPREL",	/* name */
	 FALSE,			/* partial_inplace */
	 0,			/* src_mask */
	 ALL_ONES,		/* dst_mask */
	 FALSE),		/* pcrel_offset */

  HOWTO (R_AARCH64_P32_TLSDESC,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 64,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLSDESC",	/* name */
	 FALSE,			/* partial_inplace */
	 0,			/* src_mask */
	 ALL_ONES,		/* dst_mask */
	 FALSE),		/* pcrel_offset */

  HOWTO (R_AARCH64_P32_IRELATIVE,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 64,			/* bitsize */
	 FALSE,			/* pc_relative */
...
/* Note: code such as elf32_aarch64_reloc_type_lookup expect to use e.g.
   R_AARCH64_P32_PREL as an index into this, and find the R_AARCH64_P32_PREL HOWTO
   in that slot.  */
...
static reloc_howto_type elf32_aarch64_howto_table[] = {
  ...
  /* .word: (S+A) */
  HOWTO (R_AARCH64_P32_ABS32,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 32,			/* bitsize */
	 FALSE,			/* pc_relative */
  ...
  /* .half:  (S+A) */
  HOWTO (R_AARCH64_P32_ABS16,	/* type */
	 0,			/* rightshift */
  ...
  /* .word: (S+A-P) */
  HOWTO (R_AARCH64_P32_PREL32,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 32,			/* bitsize */
	 TRUE,			/* pc_relative */
  ...
  /* .half: (S+A-P) */
  HOWTO (R_AARCH64_P32_PREL16,	/* type */
	 0,			/* rightshift */
	 1,			/* size (0 = byte, 1 = short, 2 = long) */
	 16,			/* bitsize */
	 TRUE,			/* pc_relative */
  ...
  /* MOVZ:   ((S+A) >>  0) & 0xffff */
  HOWTO (R_AARCH64_P32_MOVW_UABS_G0,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 16,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_unsigned,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_MOVW_UABS_G0",	/* name */
	 FALSE,			/* partial_inplace */
	 0xffff,		/* src_mask */
	 0xffff,		/* dst_mask */
	 FALSE),		/* pcrel_offset */
  ...
  HOWTO (R_AARCH64_P32_MOVW_UABS_G0_NC,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 16,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_MOVW_UABS_G0_NC",	/* name */
	 FALSE,			/* partial_inplace */
	 0xffff,		/* src_mask */
	 0xffff,		/* dst_mask */
	 FALSE),		/* pcrel_offset */
  ...
  /* MOVZ:   ((S+A) >> 16) & 0xffff */
  HOWTO (R_AARCH64_P32_MOVW_UABS_G1,	/* type */
	 16,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 16,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_unsigned,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_MOVW_UABS_G1",	/* name */
	 FALSE,			/* partial_inplace */
	 0xffff,		/* src_mask */
	 0xffff,		/* dst_mask */
	 FALSE),		/* pcrel_offset */
  ...
  /* MOV[ZN]:   ((S+A) >>  0) & 0xffff */
  HOWTO (R_AARCH64_P32_MOVW_SABS_G0,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 16,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_signed,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_MOVW_SABS_G0",	/* name */
	 FALSE,			/* partial_inplace */
	 0xffff,		/* src_mask */
	 0xffff,		/* dst_mask */
	 FALSE),		/* pcrel_offset */
...
/* Relocations to generate 19, 21 and 33 bit PC-relative load/store
  ...
  HOWTO (R_AARCH64_P32_LD_PREL_LO19,	/* type */
	 2,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 19,			/* bitsize */
	 TRUE,			/* pc_relative */
	 ...
	 complain_overflow_signed,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_LD_PREL_LO19",	/* name */
	 FALSE,			/* partial_inplace */
	 0x7ffff,		/* src_mask */
	 0x7ffff,		/* dst_mask */
	 TRUE),			/* pcrel_offset */
  ...
  /* ADR:    (S+A-P) & 0x1fffff */
  HOWTO (R_AARCH64_P32_ADR_PREL_LO21,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 21,			/* bitsize */
	 TRUE,			/* pc_relative */
	 ...
	 complain_overflow_signed,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_ADR_PREL_LO21",	/* name */
	 FALSE,			/* partial_inplace */
	 0x1fffff,		/* src_mask */
	 0x1fffff,		/* dst_mask */
	 TRUE),			/* pcrel_offset */
  ...
  HOWTO (R_AARCH64_P32_ADR_PREL_PG_HI21,	/* type */
	 12,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 21,			/* bitsize */
	 TRUE,			/* pc_relative */
	 ...
	 complain_overflow_signed,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_ADR_PREL_PG_HI21",	/* name */
	 FALSE,			/* partial_inplace */
	 0x1fffff,		/* src_mask */
	 0x1fffff,		/* dst_mask */
	 TRUE),			/* pcrel_offset */
  ...
  HOWTO (R_AARCH64_P32_ADD_ABS_LO12_NC,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_ADD_ABS_LO12_NC",	/* name */
	 FALSE,			/* partial_inplace */
	 0x3ffc00,		/* src_mask */
	 0x3ffc00,		/* dst_mask */
	 FALSE),		/* pcrel_offset */
  ...
  /* LD/ST8:  (S+A) & 0xfff */
  HOWTO (R_AARCH64_P32_LDST8_ABS_LO12_NC,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_LDST8_ABS_LO12_NC",	/* name */
	 FALSE,			/* partial_inplace */
	 0xfff,			/* src_mask */
	 0xfff,			/* dst_mask */
	 FALSE),		/* pcrel_offset */
  ...
  /* LD/ST16:  (S+A) & 0xffe */
  HOWTO (R_AARCH64_P32_LDST16_ABS_LO12_NC,	/* type */
	 1,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_LDST16_ABS_LO12_NC",	/* name */
	 FALSE,			/* partial_inplace */
	 0xffe,			/* src_mask */
	 0xffe,			/* dst_mask */
	 FALSE),		/* pcrel_offset */
  ...
  /* LD/ST32:  (S+A) & 0xffc */
  HOWTO (R_AARCH64_P32_LDST32_ABS_LO12_NC,	/* type */
	 2,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_LDST32_ABS_LO12_NC",	/* name */
	 FALSE,			/* partial_inplace */
	 0xffc,			/* src_mask */
	 0xffc,			/* dst_mask */
	 FALSE),		/* pcrel_offset */
  ...
  /* LD/ST64:  (S+A) & 0xff8 */
  HOWTO (R_AARCH64_P32_LDST64_ABS_LO12_NC,	/* type */
	 3,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_LDST64_ABS_LO12_NC",	/* name */
	 FALSE,			/* partial_inplace */
	 0xff8,			/* src_mask */
	 0xff8,			/* dst_mask */
	 FALSE),		/* pcrel_offset */
  ...
  /* LD/ST128:  (S+A) & 0xff0 */
  HOWTO (R_AARCH64_P32_LDST128_ABS_LO12_NC,	/* type */
	 4,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_LDST128_ABS_LO12_NC",	/* name */
	 FALSE,			/* partial_inplace */
	 0xff0,			/* src_mask */
	 0xff0,			/* dst_mask */
	 FALSE),		/* pcrel_offset */
  ...
  HOWTO (R_AARCH64_P32_TSTBR14,	/* type */
	 2,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 14,			/* bitsize */
	 TRUE,			/* pc_relative */
  ...
  HOWTO (R_AARCH64_P32_CONDBR19,	/* type */
	 2,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 19,			/* bitsize */
	 TRUE,			/* pc_relative */
  ...
  /* B:      ((S+A-P) >> 2) & 0x3ffffff */
  HOWTO (R_AARCH64_P32_JUMP26,	/* type */
	 2,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 26,			/* bitsize */
	 TRUE,			/* pc_relative */
  ...
  HOWTO (R_AARCH64_P32_CALL26,	/* type */
	 2,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 26,			/* bitsize */
	 TRUE,			/* pc_relative */
  ...
  HOWTO (R_AARCH64_P32_GOT_LD_PREL19,	/* type */
	 ...
	 complain_overflow_signed,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,		/* special_function */
	 "R_AARCH64_P32_GOT_LD_PREL19",	/* name */
	 FALSE,				/* partial_inplace */
	 0xffffe0,			/* src_mask */
	 0xffffe0,			/* dst_mask */
	 TRUE),				/* pcrel_offset */
  ...
  HOWTO (R_AARCH64_P32_ADR_GOT_PAGE,	/* type */
	 12,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 21,			/* bitsize */
	 TRUE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_ADR_GOT_PAGE",	/* name */
	 FALSE,			/* partial_inplace */
	 0x1fffff,		/* src_mask */
	 0x1fffff,		/* dst_mask */
	 TRUE),			/* pcrel_offset */

  /* LD32: GOT offset G(S) & 0xff8 */
  HOWTO (R_AARCH64_P32_LD32_GOT_LO12_NC,	/* type */
	 2,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_LD32_GOT_LO12_NC",	/* name */
	 FALSE,			/* partial_inplace */
	 0xff8,			/* src_mask */
	 0xff8,			/* dst_mask */
	 FALSE)			/* pcrel_offset */
...
static reloc_howto_type elf32_aarch64_tls_howto_table[] = {
  EMPTY_HOWTO (80),

  /* Get to the page for the GOT entry for the symbol
     (G(S) - P) using an ADRP instruction.  */
  HOWTO (R_AARCH64_P32_TLSGD_ADR_PAGE21,	/* type */
	 12,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 21,			/* bitsize */
	 TRUE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLSGD_ADR_PAGE21",	/* name */
	 FALSE,			/* partial_inplace */
	 0x1fffff,		/* src_mask */
	 0x1fffff,		/* dst_mask */
	 TRUE),			/* pcrel_offset */
  ...
  HOWTO (R_AARCH64_P32_TLSGD_ADD_LO12_NC,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLSGD_ADD_LO12_NC",	/* name */
	 FALSE,			/* partial_inplace */
	 0xfff,			/* src_mask */
	 0xfff,			/* dst_mask */
	 FALSE),		/* pcrel_offset */
  ...
  HOWTO (R_AARCH64_P32_TLSIE_ADR_GOTTPREL_PAGE21,	/* type */
	 12,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 21,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLSIE_ADR_GOTTPREL_PAGE21",	/* name */
	 FALSE,			/* partial_inplace */
	 0x1fffff,		/* src_mask */
	 0x1fffff,		/* dst_mask */
	 FALSE),		/* pcrel_offset */

  HOWTO (R_AARCH64_P32_TLSIE_LD32_GOTTPREL_LO12_NC,	/* type */
	 3,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLSIE_LD32_GOTTPREL_LO12_NC",	/* name */
	 FALSE,			/* partial_inplace */
	 0xff8,			/* src_mask */
	 0xff8,			/* dst_mask */
	 FALSE),		/* pcrel_offset */

  HOWTO (R_AARCH64_P32_TLSIE_LD_GOTTPREL_PREL19,	/* type */
	 2,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 21,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLSIE_LD_GOTTPREL_PREL19",	/* name */
	 FALSE,			/* partial_inplace */
	 0x1ffffc,		/* src_mask */
	 0x1ffffc,		/* dst_mask */
	 FALSE),		/* pcrel_offset */

  HOWTO (R_AARCH64_P32_TLSLE_MOVW_TPREL_G1,	/* type */
	 16,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLSLE_MOVW_TPREL_G1",	/* name */
	 FALSE,			/* partial_inplace */
	 0xffff,		/* src_mask */
	 0xffff,		/* dst_mask */
	 FALSE),		/* pcrel_offset */

  HOWTO (R_AARCH64_P32_TLSLE_MOVW_TPREL_G0,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLSLE_MOVW_TPREL_G0",	/* name */
	 FALSE,			/* partial_inplace */
	 0xffff,		/* src_mask */
	 0xffff,		/* dst_mask */
	 FALSE),		/* pcrel_offset */

  HOWTO (R_AARCH64_P32_TLSLE_MOVW_TPREL_G0_NC,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLSLE_MOVW_TPREL_G0_NC",	/* name */
	 FALSE,			/* partial_inplace */
	 0xffff,		/* src_mask */
	 0xffff,		/* dst_mask */
	 FALSE),		/* pcrel_offset */

  HOWTO (R_AARCH64_P32_TLSLE_ADD_TPREL_HI12,	/* type */
	 12,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLSLE_ADD_TPREL_HI12",	/* name */
	 FALSE,			/* partial_inplace */
	 0xfff,			/* src_mask */
	 0xfff,			/* dst_mask */
	 FALSE),		/* pcrel_offset */

  HOWTO (R_AARCH64_P32_TLSLE_ADD_TPREL_LO12,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLSLE_ADD_TPREL_LO12",	/* name */
	 FALSE,			/* partial_inplace */
	 0xfff,			/* src_mask */
	 0xfff,			/* dst_mask */
	 FALSE),		/* pcrel_offset */

  HOWTO (R_AARCH64_P32_TLSLE_ADD_TPREL_LO12_NC,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLSLE_ADD_TPREL_LO12_NC",	/* name */
	 FALSE,			/* partial_inplace */
	 0xfff,			/* src_mask */
	 0xfff,			/* dst_mask */
	 FALSE),		/* pcrel_offset */
...
static reloc_howto_type elf32_aarch64_tlsdesc_howto_table[] = {
  HOWTO (R_AARCH64_P32_TLSDESC_LD_PREL19,  /* type */
	 2,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 21,			/* bitsize */
	 TRUE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLSDESC_LD_PREL19",	/* name */
	 FALSE,			/* partial_inplace */
	 0x1ffffc,		/* src_mask */
	 0x1ffffc,		/* dst_mask */
	 TRUE),			/* pcrel_offset */

  HOWTO (R_AARCH64_P32_TLSDESC_ADR_PREL21,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 21,			/* bitsize */
	 TRUE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLSDESC_ADR_PREL21",	/* name */
	 FALSE,			/* partial_inplace */
	 0x1fffff,		/* src_mask */
	 0x1fffff,		/* dst_mask */
	 TRUE),			/* pcrel_offset */
  ...
  /* Get to the page for the GOT entry for the symbol
     (G(S) - P) using an ADRP instruction.  */
  HOWTO (R_AARCH64_P32_TLSDESC_ADR_PAGE21,	/* type */
	 12,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 21,			/* bitsize */
	 TRUE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLSDESC_ADR_PAGE21",	/* name */
	 FALSE,			/* partial_inplace */
	 0x1fffff,		/* src_mask */
	 0x1fffff,		/* dst_mask */
	 TRUE),			/* pcrel_offset */

  /* LD32: GOT offset G(S) & 0xfff.  */
  HOWTO (R_AARCH64_P32_TLSDESC_LD32_LO12,	/* type */
	 3,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLSDESC_LD32_LO12",	/* name */
	 FALSE,			/* partial_inplace */
	 0xfff,			/* src_mask */
	 0xfff,			/* dst_mask */
	 FALSE),		/* pcrel_offset */
  ...
  HOWTO (R_AARCH64_P32_TLSDESC_ADD_LO12,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLSDESC_ADD_LO12",	/* name */
	 FALSE,			/* partial_inplace */
	 0xfff,			/* src_mask */
	 0xfff,			/* dst_mask */
	 FALSE),		/* pcrel_offset */

  HOWTO (R_AARCH64_P32_TLSDESC_CALL,	/* type */
	 0,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 12,			/* bitsize */
	 FALSE,			/* pc_relative */
	 ...
	 complain_overflow_dont,	/* complain_on_overflow */
	 bfd_elf_generic_reloc,	/* special_function */
	 "R_AARCH64_P32_TLSDESC_CALL",	/* name */
	 FALSE,			/* partial_inplace */
	 0x0,			/* src_mask */
	 0x0,			/* dst_mask */
	 FALSE),		/* pcrel_offset */
...
{
  if (r_type >= R_AARCH64_P32_static_min && r_type < R_AARCH64_P32_static_max)
    return &elf32_aarch64_howto_table[r_type - R_AARCH64_P32_static_min];

  if (r_type >= R_AARCH64_P32_tls_min && r_type < R_AARCH64_P32_tls_max)
    return &elf32_aarch64_tls_howto_table[r_type - R_AARCH64_P32_tls_min];

  if (r_type >= R_AARCH64_P32_tlsdesc_min && r_type < R_AARCH64_P32_tlsdesc_max)
    return &elf32_aarch64_tlsdesc_howto_table[r_type - R_AARCH64_P32_tlsdesc_min];

  if (r_type >= R_AARCH64_P32_dyn_min && r_type < R_AARCH64_P32_dyn_max)
    return &elf32_aarch64_howto_dynrelocs[r_type - R_AARCH64_P32_dyn_min];

  switch (r_type)
    {
    case R_AARCH64_P32_NONE:
...
struct elf32_aarch64_reloc_map
{
...
/* All entries in this list must also be present in
   elf32_aarch64_howto_table.  */
static const struct elf32_aarch64_reloc_map elf32_aarch64_reloc_map[] = {
  {BFD_RELOC_NONE, R_AARCH64_P32_NONE},

  /* Basic data relocations.  */
  {BFD_RELOC_CTOR, R_AARCH64_P32_ABS32},
  {BFD_RELOC_32, R_AARCH64_P32_ABS32},
  {BFD_RELOC_16, R_AARCH64_P32_ABS16},
  {BFD_RELOC_32_PCREL, R_AARCH64_P32_PREL32},
  {BFD_RELOC_16_PCREL, R_AARCH64_P32_PREL16},

  /* Group relocations to low order bits of a 16, 32, 48 or 64 bit
     value inline.  */
  {BFD_RELOC_AARCH64_MOVW_G0_NC, R_AARCH64_P32_MOVW_UABS_G0_NC},

  /* Group relocations to create high bits of a 16, 32, 48 or 64 bit
     signed value inline.  */
  {BFD_RELOC_AARCH64_MOVW_G0_S, R_AARCH64_P32_MOVW_SABS_G0},

  /* Group relocations to create high bits of a 16, 32, 48 or 64 bit
     unsigned value inline.  */
  {BFD_RELOC_AARCH64_MOVW_G0, R_AARCH64_P32_MOVW_UABS_G0},
  {BFD_RELOC_AARCH64_MOVW_G1, R_AARCH64_P32_MOVW_UABS_G1},

  /* Relocations to generate 19, 21 and 33 bit PC-relative load/store.  */
  {BFD_RELOC_AARCH64_LD_LO19_PCREL, R_AARCH64_P32_LD_PREL_LO19},
  {BFD_RELOC_AARCH64_ADR_LO21_PCREL, R_AARCH64_P32_ADR_PREL_LO21},
  {BFD_RELOC_AARCH64_ADR_HI21_PCREL, R_AARCH64_P32_ADR_PREL_PG_HI21},
  {BFD_RELOC_AARCH64_ADD_LO12, R_AARCH64_P32_ADD_ABS_LO12_NC},
  {BFD_RELOC_AARCH64_LDST8_LO12, R_AARCH64_P32_LDST8_ABS_LO12_NC},
  {BFD_RELOC_AARCH64_LDST16_LO12, R_AARCH64_P32_LDST16_ABS_LO12_NC},
  {BFD_RELOC_AARCH64_LDST32_LO12, R_AARCH64_P32_LDST32_ABS_LO12_NC},
  {BFD_RELOC_AARCH64_LDST64_LO12, R_AARCH64_P32_LDST64_ABS_LO12_NC},
  {BFD_RELOC_AARCH64_LDST128_LO12, R_AARCH64_P32_LDST128_ABS_LO12_NC},

  /* Relocations for control-flow instructions. */
  {BFD_RELOC_AARCH64_TSTBR14, R_AARCH64_P32_TSTBR14},
  {BFD_RELOC_AARCH64_BRANCH19, R_AARCH64_P32_CONDBR19},
  {BFD_RELOC_AARCH64_JUMP26, R_AARCH64_P32_JUMP26},
  {BFD_RELOC_AARCH64_CALL26, R_AARCH64_P32_CALL26},

  /* Relocations for PIC.  */
  {BFD_RELOC_AARCH64_GOT_LD_PREL19, R_AARCH64_P32_GOT_LD_PREL19},
  {BFD_RELOC_AARCH64_ADR_GOT_PAGE, R_AARCH64_P32_ADR_GOT_PAGE},
  {BFD_RELOC_AARCH64_LD32_GOT_LO12_NC, R_AARCH64_P32_LD32_GOT_LO12_NC},

  /* Relocations for TLS. */
  {BFD_RELOC_AARCH64_TLSGD_ADR_PAGE21, R_AARCH64_P32_TLSGD_ADR_PAGE21},
  {BFD_RELOC_AARCH64_TLSGD_ADD_LO12_NC, R_AARCH64_P32_TLSGD_ADD_LO12_NC},
  ...
  {BFD_RELOC_AARCH64_TLSLE_MOVW_TPREL_G1, R_AARCH64_P32_TLSLE_MOVW_TPREL_G1},
  {BFD_RELOC_AARCH64_TLSLE_MOVW_TPREL_G0, R_AARCH64_P32_TLSLE_MOVW_TPREL_G0},
  {BFD_RELOC_AARCH64_TLSLE_MOVW_TPREL_G0_NC,
   R_AARCH64_P32_TLSLE_MOVW_TPREL_G0_NC},
  {BFD_RELOC_AARCH64_TLSLE_ADD_TPREL_LO12, R_AARCH64_P32_TLSLE_ADD_TPREL_LO12},
  {BFD_RELOC_AARCH64_TLSLE_ADD_TPREL_HI12, R_AARCH64_P32_TLSLE_ADD_TPREL_HI12},
  {BFD_RELOC_AARCH64_TLSLE_ADD_TPREL_LO12_NC,
   R_AARCH64_P32_TLSLE_ADD_TPREL_LO12_NC},
  {BFD_RELOC_AARCH64_TLSDESC_LD_PREL19, R_AARCH64_P32_TLSDESC_LD_PREL19},
  {BFD_RELOC_AARCH64_TLSDESC_ADR_PREL21, R_AARCH64_P32_TLSDESC_ADR_PREL21},
  {BFD_RELOC_AARCH64_TLSDESC_ADR_PAGE21, R_AARCH64_P32_TLSDESC_ADR_PAGE21},
  {BFD_RELOC_AARCH64_TLSDESC_ADD_LO12_NC, R_AARCH64_P32_TLSDESC_ADD_LO12},
  {BFD_RELOC_AARCH64_TLSDESC_LD32_LO12_NC, R_AARCH64_P32_TLSDESC_LD32_LO12},
  {BFD_RELOC_AARCH64_TLSDESC_CALL, R_AARCH64_P32_TLSDESC_CALL},
  {BFD_RELOC_AARCH64_TLS_DTPMOD64, R_AARCH64_P32_TLS_DTPMOD},
  {BFD_RELOC_AARCH64_TLS_DTPREL64, R_AARCH64_P32_TLS_DTPREL},
  {BFD_RELOC_AARCH64_TLS_TPREL64, R_AARCH64_P32_TLS_TPREL},
  {BFD_RELOC_AARCH64_TLSDESC, R_AARCH64_P32_TLSDESC},
};
				 ...
				 bfd_reloc_code_real_type code)
{
  ...
  for (i = 0; i < ARRAY_SIZE (elf32_aarch64_reloc_map); i++)
    if (elf32_aarch64_reloc_map[i].bfd_reloc_val == code)
      return elf32_aarch64_howto_from_type
	(elf32_aarch64_reloc_map[i].elf_reloc_val);
				 ...
				 const char *r_name)
{
  ...
  for (i = 0; i < ARRAY_SIZE (elf32_aarch64_howto_table); i++)
...
static bfd_boolean
elf32_aarch64_grok_prstatus (bfd *abfd, Elf_Internal_Note *note)
{
  int offset;
  size_t size;
...
#define TARGET_LITTLE_SYM               bfd_elf32_littleaarch64_vec
#define TARGET_LITTLE_NAME              "elf32-littleaarch64"
#define TARGET_BIG_SYM                  bfd_elf32_bigaarch64_vec
#define TARGET_BIG_NAME                 "elf32-bigaarch64"

#define elf_backend_grok_prstatus	elf32_aarch64_grok_prstatus
...
/* The name of the dynamic interpreter.  This is put in the .interp
   section.  */
#define ELF_DYNAMIC_INTERPRETER     "/lib32/ld.so.1"
...
static const uint32_t aarch64_adrp_branch_stub [] = {
  0x90000010,			/*	adrp	ip0, X */
				/*		R_AARCH64_P32_ADR_HI21_PCREL(X) */
  0x91000210,			/*	add	ip0, ip0, :lo12:X */
				/*		R_AARCH64_P32_ADD_ABS_LO12_NC(X) */
  0xd61f0200,			/*	br	ip0 */
};

/* FIXME: Use R_AARCH64_P32_PREL32 */
...
struct elf32_aarch64_stub_hash_entry
{
  ...
  enum elf32_aarch64_stub_type stub_type;

  /* The symbol table entry, if any, that this was derived from.  */
  struct elf32_aarch64_link_hash_entry *h;
...
typedef struct _aarch64_elf_section_data
{
  ...
  elf32_aarch64_section_map *map;
}
_aarch64_elf_section_data;

#define elf32_aarch64_section_data(sec) \
...
#define elf32_aarch64_locals(bfd) (elf_aarch64_tdata (bfd)->locals)
...
#define elf32_aarch64_hash_entry(ent) \
  ((struct elf32_aarch64_link_hash_entry *)(ent))
...
struct elf32_aarch64_link_hash_entry
{
  ...
  /* A pointer to the most recently used stub hash entry against this
     symbol.  */
  struct elf32_aarch64_stub_hash_entry *stub_cache;
...
{
  if (h)
    return elf32_aarch64_hash_entry (h)->got_type;

  if (! elf32_aarch64_locals (abfd))
    return GOT_UNKNOWN;

  return elf32_aarch64_locals (abfd)[r_symndx].got_type;
}

/* Traverse an AArch64 ELF linker hash table.  */
#define elf32_aarch64_link_hash_traverse(table, func, info)		\
...
#define elf32_aarch64_hash_table(info)					\
  ((struct elf32_aarch64_link_hash_table *) ((info)->hash))
...
struct elf32_aarch64_link_hash_table
{
  /* The main hash table.  */
  ...
  /* The index of the next R_AARCH64_P32_JUMP_SLOT entry in .rela.plt.  */
  bfd_vma next_jump_slot_index;
  /* The index of the next R_AARCH64_P32_IRELATIVE entry in .rela.plt.  */
...
elf32_aarch64_link_hash_newfunc (struct bfd_hash_entry *entry,
				 ...
				 const char *string)
{
  struct elf32_aarch64_link_hash_entry *ret =
    (struct elf32_aarch64_link_hash_entry *) entry;

  /* Allocate the structure if it has not already been allocated by a
     subclass.  */
  if (ret == NULL)
    ret = bfd_hash_allocate (table,
			     sizeof (struct elf32_aarch64_link_hash_entry));
  if (ret == NULL)
    return (struct bfd_hash_entry *) ret;

  /* Call the allocation method of the superclass.  */
  ret = ((struct elf32_aarch64_link_hash_entry *)
		   ...
		   struct bfd_hash_table *table, const char *string)
{
  ...
  if (entry != NULL)
    {
      struct elf32_aarch64_stub_hash_entry *eh;

      /* Initialize the local fields.  */
      eh = (struct elf32_aarch64_stub_hash_entry *) entry;
      eh->stub_sec = NULL;
      eh->stub_offset = 0;
      eh->target_value = 0;
...
elf_aarch64_get_local_sym_hash (struct elf32_aarch64_link_hash_table *htab,
				...
				bfd_boolean create)
{
  ...
  if (*slot)
    {
      ret = (struct elf32_aarch64_link_hash_entry *) *slot;
      return &ret->root;
    }
...
{
  struct elf32_aarch64_link_hash_entry *edir, *eind;

  edir = (struct elf32_aarch64_link_hash_entry *) dir;
  eind = (struct elf32_aarch64_link_hash_entry *) ind;
...
{
  struct elf32_aarch64_link_hash_table *ret;
  bfd_size_type amt = sizeof (struct elf32_aarch64_link_hash_table);
  ...
  if (!_bfd_elf_link_hash_table_init
      (&ret->root, abfd, elf32_aarch64_link_hash_newfunc,
       sizeof (struct elf32_aarch64_link_hash_entry), AARCH64_ELF_DATA))
    {
      free (ret);
      return NULL;
    }
  ...
  if (!bfd_hash_table_init (&ret->stub_hash_table, stub_hash_newfunc,
			    sizeof (struct elf32_aarch64_stub_hash_entry)))
    {
      free (ret);
      return NULL;
    }
...
static void
elf32_aarch64_hash_table_free (struct bfd_link_hash_table *hash)
{
  struct elf32_aarch64_link_hash_table *ret
    = (struct elf32_aarch64_link_hash_table *) hash;
			    ...
			    bfd_vma addend, bfd_boolean weak_undef_p)
{
  switch (r_type)
    {
    case R_AARCH64_P32_TLSDESC_CALL:
    case R_AARCH64_P32_NONE:
      break;
    ...
    case R_AARCH64_P32_TLSDESC_ADR_PAGE21:
    case R_AARCH64_P32_TLSGD_ADR_PAGE21:
    case R_AARCH64_P32_TLSIE_ADR_GOTTPREL_PAGE21:
      value = PG (value + addend) - PG (place);
      break;
    ...
    case R_AARCH64_P32_TLSDESC_ADD_LO12:
    case R_AARCH64_P32_TLSDESC_LD32_LO12:
    case R_AARCH64_P32_TLSGD_ADD_LO12_NC:
    case R_AARCH64_P32_TLSIE_LD32_GOTTPREL_LO12_NC:
    case R_AARCH64_P32_TLSLE_ADD_TPREL_LO12:
    case R_AARCH64_P32_TLSLE_ADD_TPREL_LO12_NC:
      value = PG_OFFSET (value + addend);
      break;

    case R_AARCH64_P32_TLSLE_MOVW_TPREL_G1:
      value = (value + addend) & (bfd_vma) 0xffff0000;
      break;
    case R_AARCH64_P32_TLSLE_ADD_TPREL_HI12:
      value = (value + addend) & (bfd_vma) 0xfff000;
      break;

    case R_AARCH64_P32_TLSLE_MOVW_TPREL_G0:
    case R_AARCH64_P32_TLSLE_MOVW_TPREL_G0_NC:
...
static enum elf32_aarch64_stub_type
...
aarch64_type_of_stub (struct bfd_link_info *info,
		      ...
		      unsigned char st_type,
		      struct elf32_aarch64_link_hash_entry *hash,
		      bfd_vma destination)
{
  bfd_vma location;
  bfd_signed_vma branch_offset;
  unsigned int r_type;
  struct elf32_aarch64_link_hash_table *globals;
  enum elf32_aarch64_stub_type stub_type = aarch64_stub_none;
  bfd_boolean via_plt_p;

  if (st_type != STT_FUNC)
    return stub_type;

  globals = elf32_aarch64_hash_table (info);
  ...
  if ((r_type == R_AARCH64_P32_CALL26 || r_type == R_AARCH64_P32_JUMP26)
...
elf32_aarch64_stub_name (const asection *input_section,
			 ...
			 const struct elf32_aarch64_link_hash_entry *hash,
			 const Elf_Internal_Rela *rel)
{
  char *stub_name;
  bfd_size_type len;
...
static struct elf32_aarch64_stub_hash_entry *
elf32_aarch64_get_stub_entry (const asection *input_section,
			      const asection *sym_sec,
			      struct elf_link_hash_entry *hash,
			      const Elf_Internal_Rela *rel,
			      struct elf32_aarch64_link_hash_table *htab)
{
  struct elf32_aarch64_stub_hash_entry *stub_entry;
  struct elf32_aarch64_link_hash_entry *h =
    (struct elf32_aarch64_link_hash_entry *) hash;
			...
			void *in_arg ATTRIBUTE_UNUSED)
{
  ...
  stub_entry = (struct elf32_aarch64_stub_hash_entry *) gen_entry;
  ...
  switch (stub_entry->stub_type)
    {
    case aarch64_stub_adrp_branch:
      if (aarch64_relocate (R_AARCH64_P32_ADR_PREL_PG_HI21, stub_bfd, stub_sec,
	...
	(elf32_aarch64_howto_from_type (R_AARCH64_P32_ADD_ABS_LO12_NC),
	 stub_bfd,
	 stub_sec,
	 stub_sec->contents,
    ...
    case aarch64_stub_long_branch:
      ...
      _bfd_final_link_relocate (elf32_aarch64_howto_from_type
				(R_AARCH64_P32_PREL32), stub_bfd, stub_sec,
				stub_sec->contents,
...
static void
group_sections (struct elf32_aarch64_link_hash_table *htab,
			  ...
			  void (*layout_sections_again) (void))
{
  ...
  struct elf32_aarch64_link_hash_table *htab = elf32_aarch64_hash_table (info);
	   ...
	   input_bfd != NULL; input_bfd = input_bfd->link_next, bfd_indx++)
	{
	  ...
	  for (section = input_bfd->sections;
	      ...
	      for (; irela < irelaend; irela++)
		{
		  ...
		  if (r_type != (unsigned int) R_AARCH64_P32_CALL26
		      && r_type != (unsigned int) R_AARCH64_P32_JUMP26)
		    continue;
		  ...
		  if (r_indx < symtab_hdr->sh_info)
		  ...
		  else
		    {
		      ...
		      hash = ((struct elf32_aarch64_link_hash_entry *)
...
elf32_aarch64_build_stubs (struct bfd_link_info *info)
{
  ...
  htab = elf32_aarch64_hash_table (info);
...
elf32_aarch64_section_map_add (asection *sec, char type, bfd_vma vma)
{
  struct _aarch64_elf_section_data *sec_data =
    elf32_aarch64_section_data (sec);
  unsigned int newidx;

  if (sec_data->map == NULL)
    {
      sec_data->map = bfd_malloc (sizeof (elf32_aarch64_section_map));
      sec_data->mapcount = 0;
      sec_data->mapsize = 1;
    }
  ...
  if (sec_data->mapcount > sec_data->mapsize)
	...
	(sec_data->map, sec_data->mapsize * sizeof (elf32_aarch64_section_map));
    }
			       ...
			       int no_wchar_warn, int pic_veneer)
{
  ...
  globals = elf32_aarch64_hash_table (link_info);
  ...
  switch (howto->type)
    ...
    case R_AARCH64_P32_ADD_ABS_LO12_NC:
      /* Corresponds to: add rd, rn, #uimm12 to provide the low order
         ...
         R_AARCH64_P32_ADR_PREL_PG_HI21 which computes the
	...
	return bfd_reloc_overflow;
      /* Used for ldr*|str* rt, [rn, #uimm12] to provide the low order
         12 bits of the page offset following R_AARCH64_P32_ADR_PREL_PG_HI21
				      ...
				      struct elf_link_hash_entry *h)
{
  ...
  switch (r_type)
    ...
    case R_AARCH64_P32_TLSDESC_ADR_PAGE21:
      return is_local
	? R_AARCH64_P32_TLSLE_MOVW_TPREL_G1 : R_AARCH64_P32_TLSIE_ADR_GOTTPREL_PAGE21;
    ...
    case R_AARCH64_P32_TLSIE_ADR_GOTTPREL_PAGE21:
      return is_local ? R_AARCH64_P32_TLSLE_MOVW_TPREL_G1 : r_type;

    case R_AARCH64_P32_TLSIE_LD32_GOTTPREL_LO12_NC:
      return is_local ? R_AARCH64_P32_TLSLE_MOVW_TPREL_G0_NC : r_type;

    case R_AARCH64_P32_TLSDESC_ADD_LO12:
    case R_AARCH64_P32_TLSDESC_CALL:
      /* Instructions with these relocations will become NOPs.  */
      return R_AARCH64_P32_NONE;
    }
...
/* Return the base VMA address which should be subtracted from real addresses
   when resolving R_AARCH64_P32_TLS_DTPREL relocation. */
...
/* Return the base VMA address which should be subtracted from real addresses
   when resolving R_AARCH64_P32_TLS_GOTTPREL64 relocations.  */
		       ...
		       unsigned long r_symndx)
{
  ...
  if (h != NULL)
  ...
  else
    {
      ...
      l = elf32_aarch64_locals (input_bfd);
			       ...
			       unsigned long r_symndx)
{
  ...
  if (h != NULL)
    {
      struct elf32_aarch64_link_hash_entry *eh;
      eh = (struct elf32_aarch64_link_hash_entry *) h;
	...
	case R_AARCH64_P32_ABS32:
	  ...
	  if (info->shared && h->non_got_ref)
		  ...
		  || info->executable)
		{
		  ...
		  outrel.r_info = ELF32_R_INFO (0, R_AARCH64_P32_IRELATIVE);
	  ...
	  if (skip)
	  ...
	  else
	    {
		 ...
		 so the symbol does not matter.  */
	      symbol = 0;
	      outrel.r_info = ELF32_R_INFO (symbol, R_AARCH64_P32_RELATIVE);
...
/* Handle TLS relaxations.  Relaxing is possible for symbols that use
   R_AARCH64_P32_TLSDESC_ADR_{PAGE, LD32_LO12_NC, ADD_LO12_NC} during a static
   link.
...
static bfd_reloc_status_type
elf32_aarch64_tls_relax (struct elf32_aarch64_link_hash_table *globals,
	...
	case R_AARCH64_P32_TLSGD_ADD_LO12_NC:
	  if (! symbol_got_offset_mark_p (input_bfd, h, r_symndx))
	      ...
	      if (need_relocs)
		{
		  ...
		  rela.r_info = ELF32_R_INFO (indx, R_AARCH64_P32_TLS_DTPMOD);
		  rela.r_addend = 0;
		  ...
		  if (indx == 0)
		  ...
		  else
		    {
			 ...
			 time.  */
		      rela.r_info =
			ELF32_R_INFO (indx, R_AARCH64_P32_TLS_DTPREL);
		      rela.r_addend = 0;
		      rela.r_offset =
			(globals->root.sgot->output_section->vma
			 + globals->root.sgot->output_offset + off
	...
	case R_AARCH64_P32_TLSIE_LD32_GOTTPREL_LO12_NC:
	  if (! symbol_got_offset_mark_p (input_bfd, h, r_symndx))
	      ...
	      if (need_relocs)
		{
		  ...
		  rela.r_info = ELF32_R_INFO (indx, R_AARCH64_P32_TLS_TPREL);
		  rela.r_offset = globals->root.sgot->output_section->vma +
		    globals->root.sgot->output_offset + off;
	...
	case R_AARCH64_P32_TLSDESC_ADD_LO12:
	  if (! symbol_tlsdesc_got_offset_mark_p (input_bfd, h, r_symndx))
	      ...
	      if (need_relocs)
		{
		  bfd_byte *loc;
		  Elf_Internal_Rela rela;
		  rela.r_info = ELF32_R_INFO (indx, R_AARCH64_P32_TLSDESC);
		  rela.r_addend = 0;
		  ...
		  /* Allocate the next available slot in the PLT reloc
		     section to hold our R_AARCH64_P32_TLSDESC, the next
...
static bfd_boolean
elf32_aarch64_copy_private_bfd_data (bfd *ibfd, bfd *obfd)
{
  flagword in_flags;
			     ...
			     const Elf_Internal_Rela * relocs)
{
  ...
  locals = elf32_aarch64_locals (abfd);
				     ...
				     struct elf_link_hash_entry *h)
{
  ...
  /* We must generate a R_AARCH64_P32_COPY reloc to tell the dynamic linker
...
elf32_aarch64_allocate_local_symbols (bfd *abfd, unsigned number)
{
  ...
  if (locals == NULL)
	...
	bfd_zalloc (abfd, number * sizeof (struct elf_aarch64_local_symbol));
      if (locals == NULL)
	return FALSE;
      elf32_aarch64_locals (abfd) = locals;
    }
  return TRUE;
}
	...
	case R_AARCH64_P32_TLSDESC_LD32_LO12:
	  {
	    ...
	    if (h)
	      {
		h->got.refcount += 1;
		old_got_type = elf32_aarch64_hash_entry (h)->got_type;
	      }
	    else
	      {
		struct elf_aarch64_local_symbol *locals;
	    ...
	    if (old_got_type != got_type)
	      {
		if (h != NULL)
		  elf32_aarch64_hash_entry (h)->got_type = got_type;
		else
		  {
		    struct elf_aarch64_local_symbol *locals;
		    locals = elf32_aarch64_locals (abfd);
...
static bfd_boolean
elf32_aarch64_section_flags (flagword *flags, const Elf_Internal_Shdr *hdr)
{
...
elf32_aarch64_allocate_dynrelocs (struct elf_link_hash_entry *h, void *inf)
{
  ...
  if (h->type == STT_GNU_IFUNC
      ...
      if (info->shared || WILL_CALL_FINISH_DYNAMIC_SYMBOL (1, 0, h))
	{
	  ...
	  /* We need to ensure that all GOT entries that serve the PLT
	     ...
	     R_AARCH64_P32_TLSDESC, must be placed after the PLT related
  ...
  if (h->got.refcount > 0)
    {
      bfd_boolean dyn;
      unsigned got_type = elf32_aarch64_hash_entry (h)->got_type;
				     ...
				     struct bfd_link_info *info)
{
  ...
  for (ibfd = info->input_bfds; ibfd != NULL; ibfd = ibfd->link_next)
      ...
      for (s = ibfd->sections; s != NULL; s = s->next)
	{
      ...
      locals = elf32_aarch64_locals (ibfd);
      if (!locals)
	continue;
  ...
  for (s = dynobj->sections; s != NULL; s = s->next)
	...
	continue;
      ...
      /* Allocate memory for the section contents.  We use bfd_zalloc
         ...
         but this way if it does, we get a R_AARCH64_P32_NONE reloc instead
         of garbage.  */
...
static inline void
elf32_aarch64_update_plt_entry (bfd *output_bfd,
				unsigned int r_type,
				       ...
				       struct bfd_link_info *info)
{
  ...
  /* Fill in the top 21 bits for this: ADRP x16, PLT_GOT + n * 8.
     ADRP:   ((PG(S+A)-PG(P)) >> 12) & 0x1fffff */
  elf32_aarch64_update_plt_entry (output_bfd, R_AARCH64_P32_ADR_PREL_PG_HI21,
				  plt_entry,
				  PG (gotplt_entry_address) -
				  PG (plt_entry_address));

  /* Fill in the lo12 bits for the load from the pltgot.  */
  elf32_aarch64_update_plt_entry (output_bfd, R_AARCH64_P32_LDST64_ABS_LO12_NC,
				  plt_entry + 4,
				  PG_OFFSET (gotplt_entry_address));

  /* Fill in the the lo12 bits for the add from the pltgot entry.  */
  elf32_aarch64_update_plt_entry (output_bfd, R_AARCH64_P32_ADD_ABS_LO12_NC,
				  plt_entry + 8,
				  PG_OFFSET (gotplt_entry_address));
  ...
  if (h->dynindx == -1
	  ...
	  && h->type == STT_GNU_IFUNC))
    {
	 ...
	 R_AARCH64_P32_IRELATIVE instead of R_AARCH64_P32_JUMP_SLOT.  */
      rela.r_info = ELF32_R_INFO (0, R_AARCH64_P32_IRELATIVE);
      rela.r_addend = (h->root.u.def.value
		       + h->root.u.def.section->output_section->vma
		       + h->root.u.def.section->output_offset);
      /* R_AARCH64_P32_IRELATIVE comes last.  */
      plt_index = htab->next_irelative_index--;
    }
  else
    {
      /* Fill in the entry in the .rela.plt section.  */
      rela.r_info = ELF32_R_INFO (h->dynindx, R_AARCH64_P32_JUMP_SLOT);
      rela.r_addend = 0;
				     ...
				     Elf_Internal_Sym *sym)
{
  ...
  if (h->got.offset != (bfd_vma) - 1
      && elf32_aarch64_hash_entry (h)->got_type == GOT_NORMAL)
    {
      Elf_Internal_Rela rela;
      bfd_byte *loc;
      ...
      if (info->shared && SYMBOL_REFERENCES_LOCAL (info, h))
	{
	  ...
	  rela.r_info = ELF32_R_INFO (0, R_AARCH64_P32_RELATIVE);
	  rela.r_addend = (h->root.u.def.value
			   + h->root.u.def.section->output_section->vma
			   + h->root.u.def.section->output_offset);
	}
      else
	{
	  ...
	  rela.r_info = ELF32_R_INFO (h->dynindx, R_AARCH64_P32_GLOB_DAT);
	  rela.r_addend = 0;
	}
  ...
  if (h->needs_copy)
	...
	abort ();
      ...
      rela.r_offset = (h->root.u.def.value
		       + h->root.u.def.section->output_section->vma
		       + h->root.u.def.section->output_offset);
      rela.r_info = ELF32_R_INFO (h->dynindx, R_AARCH64_P32_COPY);
      rela.r_addend = 0;
...
static bfd_boolean
elf32_aarch64_add_symbol_hook (bfd *abfd, struct bfd_link_info *info,
			       Elf_Internal_Sym *sym,
...
#define bfd_elf32_bfd_copy_private_bfd_data	\
  elf32_aarch64_copy_private_bfd_data
