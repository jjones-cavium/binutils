...
START_RELOC_NUMBERS (elf_aarch64_p32_reloc_type)
/* ILP32 ELF32 AARCH64 relocations  R_AARCH64_P32_* */

RELOC_NUMBER (R_AARCH64_P32_NONE, 0) /* No reloc */

FAKE_RELOC (R_AARCH64_P32_static_min, 1)
...
FAKE_RELOC (R_AARCH64_P32_static_max, 28)

FAKE_RELOC (R_AARCH64_P32_tls_min, 80)
...
FAKE_RELOC (R_AARCH64_P32_tls_max, 121)

FAKE_RELOC (R_AARCH64_P32_tlsdesc_min, 122)
...
RELOC_NUMBER (R_AARCH64_P32_TLSDESC_LD32_LO12, 125)
RELOC_NUMBER (R_AARCH64_P32_TLSDESC_ADD_LO12, 126)
RELOC_NUMBER (R_AARCH64_P32_TLSDESC_CALL, 127)
FAKE_RELOC (R_AARCH64_P32_tlsdesc_max, 128)

/* Dynamic relocations */
FAKE_RELOC (R_AARCH64_P32_dyn_min, 180)
...
FAKE_RELOC (R_AARCH64_P32_dyn_max, 189)

END_RELOC_NUMBERS (R_AARCH64_P32_end)
